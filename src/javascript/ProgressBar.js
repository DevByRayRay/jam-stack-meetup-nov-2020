// Source: https://github.com/micheleb/rn4android-slides/blob/master/ProgressBar.js
...
const Styled = styled.div`
  ...
  div {
    ...
    border-radius: 4px;
    div {
      background-color: ${(props) => props.theme.colors.progress || props.theme.colors.primary};
